...
date_time = [
  DateTime.parse("27/04/2023 08:45"),
  DateTime.parse("27/04/2023 10:00"),
  DateTime.parse("27/04/2023 13:00"),
  DateTime.parse("28/04/2023 08:45"),
  DateTime.parse("28/04/2023 10:00"),
  DateTime.parse("28/04/2023 13:00"),
  DateTime.parse("29/04/2023 08:45"),
  DateTime.parse("29/04/2023 10:00"),
  DateTime.parse("29/04/2023 13:00"),
  DateTime.parse("30/04/2023 08:45"),
  DateTime.parse("30/04/2023 10:00"),
  DateTime.parse("30/04/2023 13:00"),
  DateTime.parse("01/05/2023 08:45"),
  DateTime.parse("01/05/2023 10:00"),
  DateTime.parse("01/05/2023 13:00"),
  DateTime.parse("02/05/2023 08:45"),
  DateTime.parse("02/05/2023 10:00"),
  DateTime.parse("02/05/2023 13:00"),
  DateTime.parse("03/05/2023 08:45"),
  DateTime.parse("03/05/2023 10:00"),
  DateTime.parse("03/05/2023 13:00"),
  DateTime.parse("04/05/2023 08:45"),
  DateTime.parse("04/05/2023 10:00"),
  DateTime.parse("04/05/2023 13:00"),
  DateTime.parse("05/05/2023 08:45"),
  DateTime.parse("05/05/2023 10:00"),
  DateTime.parse("05/05/2023 13:00"),
  DateTime.parse("06/05/2023 08:45"),
  DateTime.parse("06/05/2023 10:00"),
  DateTime.parse("06/05/2023 13:00"),
  DateTime.parse("07/05/2023 08:45"),
  DateTime.parse("07/05/2023 10:00"),
  DateTime.parse("07/05/2023 13:00"),
  DateTime.parse("08/05/2023 08:45"),
  DateTime.parse("08/05/2023 10:00"),
  DateTime.parse("08/05/2023 13:00"),
  DateTime.parse("09/05/2023 08:45"),
  DateTime.parse("09/05/2023 10:00"),
  DateTime.parse("09/05/2023 13:00"),
]
price = [500, 700, 800]
seats = [2, 3, 4]
